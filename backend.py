...
import json
from tools import calculator,search_tool,date, console,delay,send_email, mail_secretary

load_dotenv()

toolbox=[calculator,search_tool,date,console,delay,send_email,mail_secretary]
#################################################################
# util section
